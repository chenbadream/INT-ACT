...
class ActionExpertModel(PreTrainedModel):
    ...
    def forward_cross_attn_layer(
        ...
        if use_cache:
            if fill_kv_cache:
                ...
                # Apply RoPE to keys using prompt position IDs
    ...
    def forward(
        ...
        alternate_pattern: str = "cross_self",  # "self_cross" or "cross_self"
    ):
        """
        ...
        Args:
            ...
            prompt_position_ids: Position IDs for prompt [B, L_prompt]
            ...
            for layer_idx in range(num_layers):
                ...
                if is_cross_attention:
                    ...
                    _, past_key_values = self.forward_cross_attn_layer(
                        ...
                        prompt_embeds,
                        layer_idx,
                        suffix_position_ids,  # This will be None, which is fine
                        prompt_position_ids,
