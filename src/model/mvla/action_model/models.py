...
class LabelEmbedder(nn.Module):
    ...
    """
    def __init__(self, in_size, hidden_size, dropout_prob=0.1, conditions_shape=(1, 1, 384)):
        super().__init__()
...
class DiT(nn.Module):
    ...
    def __init__(
        ...
        self.positional_embedding = nn.Parameter(
                scale * torch.randn(future_action_window_size + past_action_window_size + 1 + future_action_window_size + 1, hidden_size))
